...
info = '<div id="cover">';
if( n.label )
//info +=  '<div class=f><span class=l>Subreddit</span>: <span class=d>'
//   + n.title + '</span></div>';
//if( n.cover )
...
if( n.degree )
info += '<div><span class=g>Degree</span>: <span class=g>' 
   + n.degree + '</span></div>';
if( n.clustering )
info += '<div ><span class=g>Clustering</span>: <span class=g>' 
   + n.clustering + '</span></div>';
if( n.pagerank )
info += '<div ><span class=g>PageRank</span>: <span class=g>' 
   + n.pagerank + '</span></div>';
if( n.duration )
info += '<div class=f><span class=l>Year</span>: ' + n.year 
   ...
   + n.duration + '</div>';
if( n.links ) {
info += '<br><br><div ><span class=d>Related to</span>: <br>';
...
.range([1,10])
.clamp(true);
var edge_width = d3.scale.linear(10)//pow().exponent(8)
